  ...
  state: {
    ...
    users: {
      Carter: {
        ...
        userProfileImage: require('../assets/postImages/carter-profilePix.jpg')
      },
      Ethan: {
        userName: 'Ethan',
      ...
      Nova: {
        ...
        photos: [
          {
            imageUrl: require('../assets/postImages/nova-profilePix.jpg'),
            imageId: 'c1622a80-df3c-11eb-a210-09083f776f3d'
          },
          {
            imageUrl: require('../assets/postImages/nova-post1.jpeg'),
        ...
        userProfileImage: require('../assets/postImages/nova-profilePix.jpg')
      },
      Ivy: {
        userName: 'Ivy',
        ...
        photos: [
          {
            imageUrl: require('../assets/postImages/ivy-profilepix.jpg'),
        ...
        userProfileImage: require('../assets/postImages/ivy-profilepix.jpg')
      },
      Sophie: {
        userName: 'Sophie',
        ...
        photos: [
          {
            imageUrl: require('../assets/postImages/sophie-profilepix.jpg'),
        ...
        userProfileImage: require('../assets/postImages/sophie-profilepix.jpg')
      },
      Ruby: {
        userName: 'Ruby',
        emailAddress: 'Ruby@email.com',
        ...
        photos: [
          {
            imageUrl: require('../assets/postImages/ruby-profilepix.jpg'),
            imageId: 'b13fdce0-e0bf-11eb-8787-59040f6b2cc8'
          },
          {
            imageUrl: require('../assets/postImages/ruby-post.jpeg'),
        ...
        userCoverImage: '/img/defaultBg.2793204e.jpg',
        userId: '964f7d30-db3a-11eb-af32-47b0df65ae76',
        userProfileImage: require('../assets/postImages/ruby-profilepix.jpg')
      }
    },
    allUsers: {
      Carter: {
    ...
    newsFeed: {
      '9b687760-dc19-11eb-9e4e-33ab2bd5ac9e': {
        ...
        postVideos: {
          videoUrl: require('../assets/postImages/nova-post1.jpeg'),
          videoId: '',
          videoAutoplay: false
        }
      },
      ...
      '4f3847d0-e0ab-11eb-bcb8-25b2107d0c08': {
        ...
        posts: 'On the Look 😎',
        likes: ['Ava', 'Ethan', 'Ella', 'Carter', 'Sophie', 'Chloe', 'Olive'],
        unLikes: [],
        posterComment: '',
        comments: {
      ...
      '1c9c4c80-e0c0-11eb-8787-59040f6b2cc8': {
        ...
        postVideos: {
          videoUrl: require('../assets/postImages/ruby-post.jpeg'),
          videoId: '',
          videoAutoplay: false
        }
      },
      'fc9c1710-e0c1-11eb-85f3-797226efa932': {
        userName: 'Sophie',
        userId: '7b154630-db3a-11eb-af32-47b0df65ae76',
        views: ['Sophie', 'Chloe', 'Ada', 'Olive', 'Liam', 'Sebby', 'Josh'],
      ...
      '9b687760-dc19-11eb-9e4e-33a1151joshc9e': {
        ...
        postVideos: {
          videoUrl: require('../assets/postVideos/josh-post2.mp4'),
      ...
      '9b687760-dc19-11eb-9e4e-33a1151adac9e': {
        ...
        postVideos: {
          videoUrl: require('../assets/postVideos/ada-post2.mp4'),
      ...
      '9b687760-dc19-11eb-9e4e-33a1151d5ac9e': {
        ...
        postVideos: {
          videoUrl: require('../assets/postVideos/ivy-post2.mp4'),
  ...
  mutations: {
    ...
    handleLikes (state, payLoad) {
      switch (payLoad.condition) {
        case 'postLikes':
          const indexLikes = state.newsFeed[payLoad.postId].likes.indexOf(
            payLoad.userName
          )
          const indexUnikes = state.newsFeed[payLoad.postId].unLikes.indexOf(
            payLoad.userName
          )
          if (payLoad.params === 'incrementPostLikes') {
            if (
              state.newsFeed[payLoad.postId].likes.indexOf(payLoad.userName) < 0
            ) {
            ...
            if (
              state.newsFeed[payLoad.postId].unLikes.indexOf(payLoad.userName) <
              0
            ) {
        ...
        case 'commentLikes':
          const indexCommentLikes = state.newsFeed[payLoad.postId].comments[
            payLoad.commentId
          ].likes.indexOf(payLoad.userName)
          ...
          if (payLoad.params === 'incrementCommentLikes') {
            if (
              state.newsFeed[payLoad.postId].comments[
                payLoad.commentId
              ].likes.indexOf(payLoad.userName) < 0
            ) {
              state.newsFeed[payLoad.postId].comments[
                payLoad.commentId
              ].likes.push(payLoad.userName)
              state.newsFeed[payLoad.postId].comments[
                payLoad.commentId
              ].unLikes.splice(indexCommentUnikes, 1)
            } else {
              state.newsFeed[payLoad.postId].comments[
                payLoad.commentId
              ].likes.splice(indexCommentLikes, 1)
            }
          } else {
            if (
              state.newsFeed[payLoad.postId].comments[
                payLoad.commentId
              ].unLikes.indexOf(payLoad.userName) < 0
            ) {
              state.newsFeed[payLoad.postId].comments[
                payLoad.commentId
              ].unLikes.push(payLoad.userName)
              state.newsFeed[payLoad.postId].comments[
                payLoad.commentId
              ].likes.splice(indexCommentLikes, 1)
            } else {
    ...
    handleDeleteMessage (state, payLoad) {
      delete state.users[payLoad.userName].messages[payLoad.friendMessaged][
        payLoad.messageId
      ]
    },
    ...
    handleMessageStatus (state, payLoad) {
      for (const userName in state.users) {
        for (const messageUserName in state.users[userName].messages) {
          if (
            messageUserName === payLoad.userName &&
            userName !== payLoad.userName
          ) {
            for (const messageId in state.users[userName].messages[
              messageUserName
            ]) {
              if (
                state.users[userName].messages[messageUserName][messageId]
                  .userName !== payLoad.userName
              ) {
                if (
                  state.users[userName].messages[messageUserName][messageId]
                  ...
                  state.users[userName].messages[messageUserName][
                    messageId
                  ].messageStatus = 'received'
                  state.users[payLoad.userName].messages[userName][
                    messageId
                  ].messageStatus = 'received'
                }
              }
    ...
    handleMessageViewStatus (state, payLoad) {
      for (const messageId in state.users[payLoad.friendMessaged].messages[
        payLoad.userName
      ]) {
        if (
          state.users[payLoad.friendMessaged].messages[payLoad.userName][
            messageId
          ].userName === payLoad.friendMessaged
        ) {
          state.users[payLoad.friendMessaged].messages[payLoad.userName][
            messageId
          ].messageStatus = 'Read'
          state.users[payLoad.userName].messages[payLoad.friendMessaged][
            messageId
          ].messageStatus = 'Read'
        }
      }
      ...
      if (payLoad.messageViewStatus === 'Read') {
        for (const messageStatusId in state.users[payLoad.userName]
          .messageStatus) {
          state.users[payLoad.userName].messageStatus[
            messageStatusId
    ...
    handleFriendRequest (state, payLoad) {
      if (payLoad.requestStatus === 'Request Sent') {
        ...
        state.allUsers[payLoad.friendUserName].requests = state.allUsers[
          payLoad.friendUserName
        ].requests.filter(user => user.userName !== payLoad.userName)
        state.allUsers[payLoad.userName].requests = state.allUsers[
          payLoad.userName
        ].requests.filter(user => user.userName !== payLoad.friendUserName)
      }
    },
    ...
    handleFollow (state, payLoad) {
      ...
      state.users[payLoad.userName].following = state.users[
        payLoad.userName
      ].following.filter(
    ...
    handleCancelFriendRequest (state, payLoad) {
      switch (payLoad.params) {
        ...
        case 'unFriend':
          state.users[payLoad.userName].friends = state.users[
            payLoad.userName
          ].friends.filter(user => user.userName !== payLoad.friendUserName)
          state.users[payLoad.friendUserName].friends = state.users[
            payLoad.friendUserName
          ].friends.filter(user => user.userName !== payLoad.userName)
          state.allUsers[payLoad.friendUserName].requestStatus = 'Add Friend'
    ...
    handleNotificationUpdate (state, payLoad) {
      for (const notificationsId in state.users[payLoad.userName]
        .notifications) {
        if (
          state.users[payLoad.userName].notifications[notificationsId]
            .notificationType === payLoad.notificationType
        ) {
          state.users[payLoad.userName].notifications[
            notificationsId
          ].notificationStatus = 'Read'
        }
      }
    ...
    handlePostViews (state, payLoad) {
      if (!state.newsFeed[payLoad.postId].views.includes(payLoad.userName)) {
        state.newsFeed[payLoad.postId].views = [
          ...state.newsFeed[payLoad.postId].views,
          payLoad.userName
        ]
      }
    ...
    handleDisplayFunctions (state, payLoad) {
      switch (payLoad.params) {
        ...
        case 'displayClickedImage':
          state.displayFunctions.displayClickedImage =
            payLoad.displayClickedImage
        ...
        case 'wihteBackgroundLogin':
          state.displayFunctions.wihteBackgroundLogin =
            payLoad.wihteBackgroundLogin
          break
    ...
    handleAccountUpdate (state, payLoad) {
      switch (payLoad.params) {
        case 'updateProfileImage':
          state.users[payLoad.userName].userProfileImage =
        ...
        case 'updateUserName':
          state.users = {
            ...state.users,
            [payLoad.userDetails.userName]: { ...payLoad.userDetails }
          }
          for (let userName in state.users) {
            for (let messagestatusUserName in state.users[userName]
              .messageStatus) {
              if (
              ...
              if (messagestatusUserName === payLoad.userName) {
                ...
                delete state.users[userName].messageStatus[
                  messagestatusUserName
                ]
              }
            }
            ...
            for (let messsageUserName in state.users[userName].messages) {
              if (messsageUserName === payLoad.userName) {
                for (let messsageUserId in state.users[userName].messages[
                  messsageUserName
                ]) {
                  if (
                    state.users[userName].messages[messsageUserName][
                      messsageUserId
                    ].userName === payLoad.userName
                  ) {
                    state.users[userName].messages[messsageUserName][
          ...
          for (let feedId in state.newsFeed) {
            ...
            for (let commentId in state.newsFeed[feedId].comments) {
              if (
                state.newsFeed[feedId].comments[commentId].userName ===
                payLoad.userName
              ) {
                state.newsFeed[feedId].comments[commentId].userName =
                  payLoad.userDetails.userName
    ...
    handleAddImageVideo (state, payLoad) {
      if (payLoad.fileType === 'image') {
        state.users[payLoad.userName].photos = [
          ...state.users[payLoad.userName].photos,
          { imageUrl: payLoad.imageUrl, imageId: payLoad.imageId }
        ]
      } else {
        state.users[payLoad.userName].videos = [
          ...state.users[payLoad.userName].videos,
          {
