    ...
    state: {
        ...
        "newsFeed": {
            ...
            "fc9c1710-e0c1-11eb-85f3-797226efa932": {
                ...
                "postStyle": "text-theme-default",
                "postImages": [{
                    "imageUrl": "https://player.vimeo.com/external/386419950.sd.mp4?s=b1b36d5e58141a535d2fc104d284661d4b982c07&profile_id=139&oauth2_token_id=57447761",
                    "imageId": ""
                }],
                "postVideos": {
                    "videoUrl": "https://player.vimeo.com/external/386419950.sd.mp4?s=b1b36d5e58141a535d2fc104d284661d4b982c07&profile_id=139&oauth2_token_id=57447761",
    ...
    mutations: {
        ...
        handleFriendRequest(state, payLoad) {
            if (payLoad.requestStatus === 'Request Sent') {
                ...
                state.allUsers[payLoad.friendUserName].requests = state.allUsers[payLoad.friendUserName].requests.filter(
        ...
        handleCancelFriendRequest(state, payLoad) {
            switch (payLoad.params) {
                ...
                case "unFriend":
                    state.users[payLoad.userName].friends = state.users[payLoad.userName].friends.filter(
                        (user) => user.userName !== payLoad.friendUserName
                    );
                    state.users[payLoad.friendUserName].friends = state.users[payLoad.friendUserName].friends.filter(
                        (user) => user.userName !== payLoad.userName
                    );
