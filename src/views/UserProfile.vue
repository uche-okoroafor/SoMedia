...
<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae <br> facere sit quidem nobis accusantium illo explicabo doloribus laudantium omnis veritatis totam libero in laborum amet, doloremque, delectus magni! Totam, perferendis!</p>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello {{ userData.userName }}</h1>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  ...
                  }}<span class="font-weight-light">, {{ userData.age }}</span>
                </h3>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>{{ userData.city }},{{
                    userData.country
                  }}
                </div>
                <div class="h5 mt-4">
