    ...
    <div class="login">
      ...
      <form @submit.prevent="handleCreateAccount" v-if="createAccount" class="signup-form">
        ...
        <div class="login-userName-input" :class="{inputEmpty:inputEmpty1}">
          ...
          <input type="text" id="input-username" placeholder="Username" v-model="state.userName" />
        </div>
        ...
        <div class="login-userName-input">
          ...
          <input type="text" id="input-username" placeholder="First Name" v-model="state.firstName" />
        </div>
        ...
        <div class="login-userName-input">
          ...
          <input type="text" id="input-username" placeholder="LastName" v-model="state.lastName" />
        </div>
        ...
        <div class="signup-directives">
          ...
          <span style="color: red;" v-if="userExists">Username or EmailAddress already Exist</span>
