        ...
        <ul>
          ...
          <li @click="toggleDisplay('displayProfile')">
            <router-link
              ...
              :style="displayProfile && activeLink"
              >Profile</router-link
            >
          </li>
          <li @click="toggleDisplay('displayPhotos')">
            <router-link
              ...
              :style="displayPhotos && activeLink"
              >Photos</router-link
            >
          </li>
    ...
    <div class="timeline-container">
      <div class="sideBar" v-if="displayPhotosContainer">
        <div class="timeline-user-photos">
          ...
          <div
            v-if="
              photoEmpty && userData.userName === $store.state.userData.userName
            "
            class="photo-empty"
          >
            <span class="comment"> Add Your Photos </span>
          </div>
          <div
            v-if="
              photoEmpty && userData.userName !== $store.state.userData.userName
            ...
            class="photo-empty"
          >
            <span class="comment"> {{ handleUserNames }} has no Photos </span>
          </div>
      ...
      <div class="components-container" :style="componentsContainer">
        ...
        <Friends
          :userName="handleUserNames"
          v-show="displayFriends"
          @toggleView="toggleDisplay"
        />
        <Profiles
          :userName="handleUserNames"
      ...
      >
        <div class="active-container">
          ...
          <ul v-for="activity in activities">
            <li v-if="activity.activity === 'Created account'">
              <span
                v-if="
                  this.userData.userName === this.$store.state.userData.userName
                "
            ...
            <li v-if="activity.activity === 'followed'">
              <span
                v-if="
                  this.userData.userName === this.$store.state.userData.userName
                "
              ...
              >
              started <br />
              following {{ activity.friendUserName }} <br />
              {{ showDate(activity.activityDate) }}
              <hr />
            </li>
            <li v-if="activity.activity === 'posted'">
              <span
                v-if="
                  this.userData.userName === this.$store.state.userData.userName
                "
              ...
              >
              made <br />
              a post <br />{{ showDate(activity.activityDate) }}
              <hr />
            </li>
            <li
              v-if="
                activity.activity === 'commented' &&
                  activity.posterUserName !== this.userData.userName
              "
            >
              <span
                v-if="
              ...
              >
              commented on a <br />
              post by {{ activity.posterUserName }} <br />
              {{ showDate(activity.activityDate) }}
              <hr />
            </li>
            <li
            ...
            <li
              v-if="
                activity.activity === 'liked' &&
                  activity.posterUserName !== userData.userName
              "
            >
              <span
                v-if="
              ...
              liked a <br />
              post by
              {{ activity.posterUserName }} <br />
              {{ showDate(activity.activityDate) }}
              <hr />
            </li>
            <li
              v-if="
                activity.activity === 'likedComment' &&
                  activity.posterUserName !== activity.commenterUserName &&
                  activity.posterUserName !== this.userData.userName
              "
            >
              <span
              ...
              >
              liked a <br />
              comment by {{ activity.commenterUserName }} on
              {{ activity.posterUserName }}'s Post <br />
              {{ showDate(activity.activityDate) }}
              <hr />
            </li>
            <li
            ...
            >
              ...
              liked a <br />
              comment by {{ activity.commenterUserName }} on
              {{ handleGender(activity.posterUserName) }} Post<br />
              {{ showDate(activity.activityDate) }}
              <hr />
            </li>
            <li
            ...
            >
              ...
              <span
                v-if="
                  this.userData.userName !== this.$store.state.userData.userName
                "
                >{{ handleGender(this.userData.userName) }}</span
              >
              Post<br />
              {{ showDate(activity.activityDate) }}
              <hr />
  ...
  methods: {
    ...
    handleShowFriends(userName) {
      userName === this.$store.state.userData.userName &&
        this.$router.push({ name: "Friends", params: { userName: userName } });
      userName !== this.$store.state.userData.userName &&
    ...
    toggleDisplay(params) {
      params === "displayPhotos"
        ? (this.componentsContainer = "width:100%")
    ...
    activities() {
      ...
      for (const activitiesId in this.userData.activities) {
        for (const activityId in unDuplicatedactivities) {
          if (
            this.userData.activities[activitiesId].activity ===
              unDuplicatedactivities[activityId].activity &&
            this.userData.activities[activitiesId].posterUserName ===
              unDuplicatedactivities[activityId].posterUserName &&
            this.userData.activities[activitiesId].userName ===
              unDuplicatedactivities[activityId].userName &&
            this.userData.activities[activitiesId].commenterUserName ===
              unDuplicatedactivities[activityId].commenterUserName &&
            this.userData.activities[activitiesId].friendUserName ===
              unDuplicatedactivities[activityId].friendUserName
          ) {
            counter++;
            if (counter > 1) {
