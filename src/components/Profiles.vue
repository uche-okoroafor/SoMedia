      ...
      <div class="row justify-content-center">
        <div class="col-lg-3 order-lg-2">
          <div class="card-profile-image">
            <a href="#">
              <img :src="handleUserProfilePic(userName)" class="rounded-circle">
            </a>
          </div>
        </div>
      </div>
            ...
            <div class="card-profile-stats d-flex justify-content-center mt-md-5">
              <div>
                ...
                <span class="description" @click="$emit('toggleView','displayFriends')">
                  <router-link :to="{name:'Timeline',params:{userName:userData.userName,Timeline:'Friends'}}">Friends
                  </router-link>
                </span>
              </div>
              <div>
...
this.userData.posts =postCount
      ...
      handleUserViewed() {
        return this.userName === this.$store.state.userData.userName ? false : true
